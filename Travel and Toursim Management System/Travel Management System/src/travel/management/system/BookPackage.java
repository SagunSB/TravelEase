...
public class BookPackage extends JFrame {
	...
	public BookPackage(String username) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ensureBookPackageTable(c);
                                PreparedStatement ps = c.c.prepareStatement("insert into bookPackage(username, `package`, persons, id, number, phone, price) values(?, ?, ?, ?, ?, ?, ?)");
                                ps.setString(1, username);
                                ps.setString(2, s1);
                                ps.setString(3, t1.getText());
                                ps.setString(4, l2.getText());
                                ps.setString(5, l3.getText());
                                ps.setString(6, l4.getText());
                                ps.setString(7, l5.getText());
                                ps.executeUpdate();
                                ps.close();
        ...
        private void ensureBookPackageTable(Conn c) throws SQLException {
            c.s.executeUpdate("create table if not exists bookPackage(username varchar(30), `package` varchar(40), persons varchar(20), id varchar(30), number varchar(20), phone varchar(20), price varchar(20))");
        }
}
