		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            try{
                                ...
                                PreparedStatement ps = c.c.prepareStatement("select * from customer where username = ?");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                PreparedStatement ps = c.c.prepareStatement("delete from customer where username = ?");
                                ps.setString(1, s1);
                                ps.executeUpdate();
                                ps.close();
